...
interface ProductDetailsProps {
    product: 
        Prisma.ProductGetPayload<{include: {restaurant: {
            select: {
                name: true;
                avatarImageUrl: true;
            };
...
const ProductDetails = ({ product }: ProductDetailsProps) => {
    ...
    return ( 
        <>
            ...
            {/*preco e quantidade*/}
            <div className="flex intens-center justify-between mt-3">
            ...
            <Button className="rounded-full w-full" onClick={handeleAddToCart}>
                Adicionar à sacola
            </Button>
        </div>
        <CartSheet/>
